    ...
    <div id="home" className="flex flex-row items-center relative h-fit lg:h-[580px] w-full overflow-hidden py-[20px] bg-cover bg-top bg-no-repeat" style={{ backgroundImage: `url(${hero3})` }}>
        ...
        <div className="flex flex-col items-center justify-center mx-auto h-fit p-2">
            <div className="w-full lg:w-[1120px] flex flex-col items-center justify-start gap-[20px] mx-auto pt-[20px] lg:pt-0">
                <div className="text-yellow-400 text-center font-['Poppins-Bold',_sans-serif] text-[34px] lg:text-[55px] font-bold">
            ...
            <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-6 mt-10">
                <Link to="steps" smooth={true} duration={500} className="rounded-[10px] pt-[19px] pr-10 pb-[19px] pl-10 flex flex-row gap-2.5 items-start justify-start cursor-pointer no-underline hover:no-underline" style={{backgroundColor: "oklch(68.1% 0.162 75.834)", cursor: "pointer", textDecoration: "none"}}>
                ...
                <Link to="people" smooth={true} duration={500} className="rounded-[10px] border-2 border-solid border-yellow-500 pt-[19px] pr-10 pb-[19px] pl-10 flex flex-row gap-2.5 items-start justify-start cursor-pointer no-underline hover:no-underline" style={{cursor: "pointer", textDecoration: "none"}}>
                    <div className="text-[#ffffff] text-left font-['Inter-Bold',_sans-serif] text-lg font-bold relative no-underline hover:no-underline">
                        People To Know
                    </div>
                </Link>
