...
function Network() {
  return (
    ...
    <div id='network' className="flex flex-col items-start justify-center relative overflow-hidden pt-[50px]">
        ...
        <div className="w-[95%] lg:w-[70%] flex flex-col items-center justify-start mx-auto">
            <div className=" static">
                <div className="lg:w-[100%] playwrite-text text-[#303a42] text-center font-['Poppins-Bold',_sans-serif] text-[20px] lg:text-[25px] font-bold">
    ...
    <div className='mt-[30px] mb-[30px]'>
        <blockquote className="text-[#303a42] text-center text-[20px] lg:text-[25px] font-bold relative w-[90%] italic mx-auto">
